          ...
          <ul className="mt-[70px] flex flex-1 flex-col ">
            ...
            <Link
              ...
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/agenda'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/agenda', 'Agenda')
              }
            >
            ...
            {/* Participants */}
            <Link
              href="/hr/hr-dashboard/participants"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/participants'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/participants', 'Participants')
              }
            >
            ...
            {/* Mentors */}
            <Link
              href="/hr/hr-dashboard/mentors"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/mentors'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/mentors', 'Mentors')
              }
            >
            ...
            <Link
              ...
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/judges', 'Judges')
              }
            >
            ...
            {/* Challenges */}
            <Link
              href="/hr/hr-dashboard/challenges"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/challenges'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/challenges', 'Challenges')
              }
            >
            ...
            {/* Feedbacks */}
            <Link
              href="/hr/hr-dashboard/feedbacks"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/feedbacks'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/feedbacks', 'Feedbacks')
              }
            >
            ...
            {/* analytics */}
            <Link
              href="/hr/hr-dashboard/analytics"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/analytics'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/analytics', 'analytics')
              }
            >
            ...
            {/* Sponsors */}
            <Link
              href="/hr/hr-dashboard/sponsors"
              className={`flex hover:bg-white/80 hover:text-[#1976D2] items-center gap-[10px] font-medium  cursor-pointer duration-300 transition-all w-full px-[20px] py-[8px] ${
                activeLink === '/hr/hr-dashboard/sponsors'
                  ? 'bg-white text-[#1976D2] font-semibold'
                  : 'bg-[#1976D2] text-white'
              }`}
              onClick={() =>
                handleLinkClick('/hr/hr-dashboard/sponsors', 'Sponsors')
              }
            >
